      ...
      <header className="border-b sticky top-0 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 z-50">
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-2 font-bold text-xl">
            <span className="text-primary">FinTrust</span>
          </div>
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-secondary/50 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl mb-4">Why Choose FinTrust?</h2>
      ...
      <footer className="w-full py-12 md:py-16 bg-background border-t">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          ...
          <div className="mt-12 pt-8 border-t text-center text-sm text-muted-foreground">
            <p>&copy; {new Date().getFullYear()} FinTrust Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
